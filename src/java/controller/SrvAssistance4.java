...
@WebServlet(name = "SrvAssistance4", urlPatterns = {"/deleteAssistance"})
public class SrvAssistance4 extends HttpServlet {
        ...
        try {            
            ...
            if(id != null){
                ...
                if(connection != null){
                    ...
                    String queryString = "delete from assistance where id='" + id +"'";
